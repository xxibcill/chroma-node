...
const api: ChromaNodeApi = {
  ...
  syncCurrentProject: (request: SyncCurrentProjectRequest) => ipcRenderer.invoke(IpcChannel.SyncCurrentProject, request),
  ...
  snapshotCurrentVersion: (request: VersionSnapshotCurrentRequest) => ipcRenderer.invoke(IpcChannel.VersionSnapshotCurrent, request),
  setVersionStatus: (request: VersionSetStatusRequest) => ipcRenderer.invoke(IpcChannel.VersionSetStatus, request),
  ...
  validateReviewPackage: (request: ReviewPackageValidateRequest) => ipcRenderer.invoke(IpcChannel.ReviewPackageValidate, request),
  ...
  estimateHandoffPackage: (request: HandoffPackageEstimateRequest) => ipcRenderer.invoke(IpcChannel.HandoffEstimate, request),
